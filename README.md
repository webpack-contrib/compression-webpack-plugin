...
| **[`overwriteOriginalAssets`](#overwriteOriginalAssets)** |                `{Boolean}`                |                            `false`                            | Whether to overwrite the original assets or not                                                               |
...
Whether to overwrite the original assets when the names are the same or not.
