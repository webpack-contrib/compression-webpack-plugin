...
You can use `1` value to process assets that are smaller than the original.  Use a value of `999` to process all assets even if they are larger than the original (useful when you are pre-zipping all assets for AWS)
